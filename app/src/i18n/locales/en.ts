...
export const en: Record<keyof typeof zhHans, string> = {
  ...
  "outputMode.bilingual": "Bilingual",
  ...
  "context.placeholder": "e.g. Bob and Alice are arguing, then Bob storms out of the room.",
  "context.desc": "Background info, not translation instructions: character relationships, tone, setting. Sent only for the first part of each batch, and only in the source language.",
