...
export const en: Record<keyof typeof zhHans, string> = {
  ...
  "model.microsoft.desc": "Fast and broadly supported, but its context window is limited to about one or two sentences — expect less consistency across lines.",
  ...
  "detect.mode.manual": "Manual",
  "detect.redo": "Detect again",
  "detect.cloud.hint": "Language will be detected automatically when translation starts.",
  "detect.manual.hint": "Pick the source language above.",
