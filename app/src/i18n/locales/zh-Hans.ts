export const zhHans = {
  ...
  "context.placeholder": "例如：鲍勃和爱丽丝正在争吵，随后鲍勃摔门离开。",
  "context.desc": "这里填写背景信息，不是翻译指令，比如人物关系、语气、场景设定。只会随每个批次的前段发送，且只使用原文语言。",
  ...
  "glossary.sourcePlaceholder": "例如：Bob",
  "glossary.targetPlaceholder": "例如：鲍勃",
  "glossary.remove": "删除",
  "glossary.addRow": "+ 添加一行",
  "glossary.bulkSourcePlaceholder": "每行一个术语，例如 Bob",
  "glossary.bulkTargetPlaceholder": "对应译词，顺序需一致，例如 鲍勃",
