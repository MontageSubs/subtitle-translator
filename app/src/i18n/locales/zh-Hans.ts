export const zhHans = {
  ...
  "app.feature.1.desc": "纯粹的社区驱动原则，无广告且隐私友好。",
  "app.feature.2.title": "场景级连贯",
  "app.feature.2.desc": "创新式合并短句推理，跨句上下文不再割裂。",
  "app.feature.3.title": "专业级排版",
  "app.feature.3.desc": "精准匹配字幕时间轴，支持术语表与双语叠放。",
  ...
  "task.quality.missingCues": "⚠ {count} 条字幕未翻译",
